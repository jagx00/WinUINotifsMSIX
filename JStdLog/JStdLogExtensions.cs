...
using JStdLog.Enrichers;

namespace JStdLog
{
    public static class JStdLogExtensions

    {
        ...
        public static jStdLogViewModel jStdLogViewModel;
        ...
        static JStdLogExtensions()

        {
           
            jStdLogViewModel = new jStdLogViewModel();
        }
