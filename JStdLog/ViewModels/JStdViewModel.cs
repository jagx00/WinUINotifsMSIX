...
namespace JStdLog
{
    ...
    public class jStdLogViewModel : BindableBase, INotifyPropertyChanged
//    public class jStdLogViewModel : ViewModelBase, INotifyPropertyChanged
    {
        string s1;
        public jStdLogViewModel()
        {
        ...
        {
            get => JStdLogExtensions.levelSwitchOS.MinimumLevel;
            set
            {
                if (!value.Equals(JStdLogExtensions.levelSwitchOS.MinimumLevel))
                {
                    JStdLogExtensions.levelSwitchOS.MinimumLevel = value;
                    OnPropertyChanged();
                }
            }
        }
        ...
        {
            get => JStdLogExtensions.frameworkSwitchOS.MinimumLevel;
            set
            {
                if (!JStdLogExtensions.frameworkSwitchOS.MinimumLevel.Equals(value))
                {
                    JStdLogExtensions.frameworkSwitchOS.MinimumLevel = value;
                    OnPropertyChanged();
                }
            }
        }
